...
const TShirtConfigurator = () => {
  ...
  const handleShirtLoaded = useCallback((loadedShirt) => {
    setShirt(loadedShirt);
  }, []);

  const handleTextureUpdate = useCallback(
    (canvas) => {
      if (shirt) {
        console.log("shirt", shirt, shirt.getObjectByName("front"));
        console.log("canvasFabric", document.getElementById("canvasFabric"));
  ...
  const handleColorChange = useCallback(
    (id, color) => {
      ...
      document.getElementById("Two").setAttribute("fill", color);
      //back stripes triangle
      document.getElementById("Two1").setAttribute("fill", color);
    ...
    <>
      ...
      <div className="card">
        <div className="obj01 item">
          <ThreeRenderer onShirtLoaded={handleShirtLoaded} />
        </div>
        ...
        <div className="obj03 item">
          <FabricCanvas onTextureUpdate={handleTextureUpdate} />
          <br />
          <br />
          <br />
          <br />
